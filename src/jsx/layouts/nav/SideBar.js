        ...
        <PerfectScrollbar className="deznav-scroll">
          ...
          <MM className="metismenu" id="menu">
            <li className={`${dashBoard.includes(path) ? "mm-active" : ""}`}>
              <Link className="has-arrow ai-icon" to="#" >
				...
				<ul >
					...
					<li>
						<Link className={`${path === "event" ? "mm-active" : ""}`} onClick={() => this.props.onClick()} to="/event">
							Event
						</Link>
					</li>
					<li>
						<Link className={`${path === "event-detail" ? "mm-active" : ""}`} onClick={() => this.props.onClick()} to="/event-detail" >
							 Event Detail
						</Link>
					</li>
					<li>
						<Link className={`${path === "customers" ? "mm-active" : ""}`} onClick={() => this.props.onClick()} to="/customers">
							Customers
						</Link>
					</li>
					<li>
			...
			<div className="copyright">
				<p>
				  <strong>Acara Ticketing Dashboard</strong> © 2022 All Rights
				  Reserved
				</p>
				<p>
				  Made with{" "}
